<template>
  <div>
    <section
      class="page-header"
      :style="'background-image: linear-gradient(120deg, '+ configuration.backgroundColorLeft+', '+ configuration.backgroundColorRight+');color: '+ configuration.fontColor +';'"
    >
      ...
      <el-card shadow="never" :body-style="{ padding: '0px' }">
        <el-row>
          ...
          <el-col :span="8" style="text-align: center;padding: 12px 0px 0px 10px">
            ...
            <audio ref="music" loop autoplay v-if="configuration.audioAutoPlay">
              <source :src="configuration.audioUrl" type="audio/mpeg"/>
            </audio>
          ...
          <el-col :span="4" style="text-align: right;">
            ...
            <div style="color:#606266;">
              ...
              &nbsp;{{ master.location ? master.location : '未填写地址' }}
              <br/>
            </div>
          </el-col>
          <el-col :span="2" style="text-align: center;">
            <img
              v-popover:bigAvatar
              :src="'http://localhost:1337' + master.avatar.url"
            ...
            >
              ...
              <br/>
              <i class="el-icon-location"></i>
              &emsp;{{ master.location }}
              <br/>
              <img :src="'http://localhost:1337' + master.avatar.url" style="width: 200px;height: 200px;"/>
            </el-popover>
          </el-col>
        </el-row>
      </el-card>
...
export default {
  ...
  computed: {
    configuration () {
      return this.$static.allStrapiConfiguration.edges[0].node
    },
    master () {
      return this.$static.allStrapiMaster.edges[0].node
    },
  },
  watch: {
  ...
  methods: {
    selectTopbar (index) {
      ...
      switch (index) {
        case '#githubHome':
          window.open('https://github.com/' + this.configuration.githubUsername)
          break
        case '#blog':
          if (this.blog) {
            window.open(
